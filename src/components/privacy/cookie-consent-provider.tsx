        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">
              We use essential cookies to keep SMVIA secure and enable account
      ...
      >
        <SheetHeader className="border-b border-border px-6 py-6 pr-14">
          ...
          <SheetDescription className="pt-2 text-left leading-6">
            Choose which optional cookies SMVIA may use. Essential cookies
          ...
          <PreferenceRow
            ...
            description={
              globalPrivacyControlEnabled
                ...
                : "Would support targeted advertising or cross-context data sharing. SMVIA does not currently use these cookies."
            }
