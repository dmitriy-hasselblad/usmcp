...
export const metadata: Metadata = {
  title: "Cookie Notice",
  description:
    "Learn how USHCE uses essential and optional cookies and manage your privacy choices.",
}
...
export default function CookieNoticePage() {
  return (
    ...
    >
      ...
      <section>
        <h2>2. How USHCE uses cookies</h2>
        <p>
          USHCE uses essential cookies for security, authentication, account
        ...
        <div className="overflow-hidden rounded-2xl border border-border">
          ...
          <div className="grid gap-2 p-4 sm:grid-cols-[11rem_1fr]">
            ...
            <span>
              ...
              behavioral advertising. USHCE does not currently use advertising
              cookies.
            </span>
          </div>
        </div>
      ...
      <section>
        ...
        <p>
          You may also remove cookies through your browser. Removing the USHCE
      ...
      <section>
        ...
        <p>
          When a supported browser sends a Global Privacy Control signal, USHCE
