...
export const metadata: Metadata = {
  title: "Cookie Notice",
  description:
    "Learn how SMVIA uses essential and optional cookies and manage your privacy choices.",
}

export default function CookieNoticePage() {
  return (
    <LegalPageShell
      description="This notice explains how SMVIA uses cookies and similar technologies, which services are currently active, and how you can control optional uses."
    ...
    >
      ...
      <section>
        <h2>2. How SMVIA uses cookies</h2>
        <p>
          SMVIA uses essential cookies for security, authentication, account
        ...
        <div className="overflow-hidden rounded-2xl border border-border">
          ...
          <div className="grid gap-2 border-b border-border bg-muted/45 p-4 sm:grid-cols-[11rem_1fr]">
            ...
            <span>
              Optional. When you allow this category, SMVIA uses Vercel Web
          ...
          <div className="grid gap-2 p-4 sm:grid-cols-[11rem_1fr]">
            ...
            <span>
              ...
              behavioral advertising. SMVIA does not currently use advertising
              cookies.
            </span>
          </div>
        </div>
      ...
      <section>
        ...
        <p>
          ...
          SMVIA adds another optional provider, this notice and the consent
      ...
      <section>
        ...
        <p>
          You may also remove cookies through your browser. Removing the SMVIA
      ...
      <section>
        ...
        <p>
          When a supported browser sends a Global Privacy Control signal, SMVIA
