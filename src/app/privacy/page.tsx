...
export const metadata: Metadata = {
  ...
  description:
    "Learn how SMVIA collects, uses, protects, and provides choices for personal information.",
}

export default function PrivacyPolicyPage() {
  return (
    <LegalPageShell
      description="This policy describes the personal information SMVIA handles while building a secure career and hiring ecosystem for U.S. healthcare."
      lastUpdated="July 29, 2026"
      title="Privacy Policy"
    >
      <aside className="rounded-2xl border border-primary/15 bg-primary/5 p-5 text-sm leading-6">
        SMVIA is currently a development-stage platform. This policy describes
      ...
      <section>
        ...
        <p>Depending on how you use SMVIA, we may collect:</p>
        <ul>
          <li>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            ...
            SMVIA, or the public; and
          </li>
          <li>as part of a merger, financing, or business transfer.</li>
        </ul>
        <p>
          SMVIA does not currently sell personal information or share it for
      ...
      <section>
        ...
        <p>
          SMVIA will not discriminate against a user for exercising an
      ...
      <section>
        ...
        <p>
          SMVIA recognizes supported Global Privacy Control signals for
      ...
      <section>
        <h2>7. Security</h2>
        <p>
          SMVIA uses administrative, technical, and organizational safeguards
      ...
      <section>
        ...
        <p>
          SMVIA is a career and hiring platform, not a patient-care or medical
      ...
      <section>
        <h2>9. Children</h2>
        <p>
          SMVIA is intended for healthcare professionals, adult students,
      ...
      <section>
        ...
        <p>
          We may update this policy as SMVIA develops. The “Last updated” date
