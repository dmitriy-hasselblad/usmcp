...
export default async function SalaryProfilePage({ params }: PageProps) {
  ...
  const [liveJobs, usaJobs, officialAtsJobs, organizations] = await Promise.all([
    getPublishedJobs(),
    getUsaJobsHealthcareOpportunities(),
    getOfficialAtsHealthcareOpportunities(),
    getPublicOrganizations(),
  ])
  const stateJobs = [...liveJobs, ...usaJobs, ...officialAtsJobs]
