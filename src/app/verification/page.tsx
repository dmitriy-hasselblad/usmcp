...
export const metadata: Metadata = {
  ...
  description: "Learn what the SMVIA Verified organization badge means during Early Access.",
}
        ...
        <section className="border-b border-border bg-white">
          <div className="mx-auto max-w-4xl px-5 py-14 lg:px-8 lg:py-20">
            ...
            <h1 className="mt-5 text-4xl font-semibold tracking-[-0.055em] sm:text-5xl">
              What verification means on SMVIA.
            </h1>
            <p className="mt-5 max-w-3xl text-lg leading-8 text-muted-foreground">
              During Early Access, this badge means SMVIA completed a manual review of an organization&apos;s identity and public information before displaying the verified signal.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto grid max-w-4xl gap-6 px-5 py-12 lg:px-8 lg:py-16">
          <Card className="bg-white">
            <CardContent className="p-7 sm:p-8">
              ...
              <h2 className="mt-5 text-2xl font-semibold">What SMVIA reviews</h2>
          ...
          <Card className="bg-white">
            <CardContent className="p-7 sm:p-8">
              ...
              <p className="mt-4 leading-7 text-muted-foreground">
                An organization without this badge is shown neutrally. It may be new to SMVIA, awaiting review, or not yet eligible for verification. The absence of a badge is not a negative rating.
              </p>
            </CardContent>
          </Card>
