-- Keep the identity-checked social OAuth onboarding function in source control.
-- This definition already exists in Production from the earlier social OAuth rollout.
